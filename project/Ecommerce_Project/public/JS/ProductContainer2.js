...
var loadProductDetails1 = (data, index) => {
    var mainLiTag = $("<li/>");
    $(".productDetailsContainer1").append(mainLiTag);
...
document.addEventListener("DOMContentLoaded", () => {
    for (var i = 0; i < productData1.length; i++){
        loadProductDetails1(productData1[i], i);
    } 
});
